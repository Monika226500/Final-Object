...
import com.zhumeng.api.model.PmsProductFullReduction;
import com.zhumeng.api.model.PmsProductFullReductionExample;
...
public interface PmsProductFullReductionMapper {
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsProductFullReductionSqlProvider.class, method="countByExample")
    long countByExample(PmsProductFullReductionExample example);

    @DeleteProvider(type= com.zhumeng.mall.provider.mapper.PmsProductFullReductionSqlProvider.class, method="deleteByExample")
    ...
    @InsertProvider(type= com.zhumeng.mall.provider.mapper.PmsProductFullReductionSqlProvider.class, method="insertSelective")
    int insertSelective(PmsProductFullReduction record);

    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsProductFullReductionSqlProvider.class, method="selectByExample")
    @Results({
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductFullReductionSqlProvider.class, method="updateByExampleSelective")
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductFullReductionSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") PmsProductFullReduction record, @Param("example") PmsProductFullReductionExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductFullReductionSqlProvider.class, method="updateByPrimaryKeySelective")
