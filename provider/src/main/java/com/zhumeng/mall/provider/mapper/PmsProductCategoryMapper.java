...
import com.zhumeng.api.model.PmsProductCategoryExample;
...
public interface PmsProductCategoryMapper {
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsProductCategorySqlProvider.class, method="countByExample")
    long countByExample(PmsProductCategoryExample example);

    @DeleteProvider(type= com.zhumeng.mall.provider.mapper.PmsProductCategorySqlProvider.class, method="deleteByExample")
    ...
    @InsertProvider(type= com.zhumeng.mall.provider.mapper.PmsProductCategorySqlProvider.class, method="insertSelective")
    @Options(useGeneratedKeys=true, keyProperty="id", keyColumn="id")//返回主键送到输入形参中
    int insertSelective(PmsProductCategory record);

    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsProductCategorySqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
    ...
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsProductCategorySqlProvider.class, method="selectByExample")
    @Results({
        @Result(column="id", property="id", jdbcType= JdbcType.BIGINT, id=true),
        @Result(column="parent_id", property="parentId", jdbcType= JdbcType.BIGINT),
        @Result(column="name", property="name", jdbcType= JdbcType.VARCHAR),
    ...
    List<PmsProductCategory> selectByExample(PmsProductAttributeCategoryExample example);
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductCategorySqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") PmsProductCategory record, @Param("example") PmsProductCategoryExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductCategorySqlProvider.class, method="updateByExampleWithBLOBs")
    int updateByExampleWithBLOBs(@Param("record") PmsProductCategory record, @Param("example") PmsProductCategoryExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductCategorySqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") PmsProductCategory record, @Param("example") PmsProductCategoryExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductCategorySqlProvider.class, method="updateByPrimaryKeySelective")
    ...
    @Results({
            ...
            @Result(property = "children",javaType = List.class,column="id",
                    many = @Many(select="com.zhumeng.mall.provider.mapper." +
