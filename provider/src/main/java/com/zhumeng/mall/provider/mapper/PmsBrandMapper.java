...
public interface PmsBrandMapper {
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsBrandSqlProvider.class, method="countByExample")
    long countByExample(PmsBrandExample example);

    @DeleteProvider(type= com.zhumeng.mall.provider.mapper.PmsBrandSqlProvider.class, method="deleteByExample")
    ...
    @InsertProvider(type= com.zhumeng.mall.provider.mapper.PmsBrandSqlProvider.class, method="insertSelective")
    @Options(useGeneratedKeys=true, keyProperty="id", keyColumn="id")//返回主键送到输入形参中
    int insertSelective(PmsBrand record);

    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsBrandSqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
    ...
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsBrandSqlProvider.class, method="selectByExample")
    @Results({
        @Result(column="id", property="id", jdbcType= JdbcType.BIGINT, id=true),
        @Result(column="name", property="name", jdbcType= JdbcType.VARCHAR),
        @Result(column="first_letter", property="firstLetter", jdbcType= JdbcType.VARCHAR),
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsBrandSqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") PmsBrand record, @Param("example") PmsBrandExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsBrandSqlProvider.class, method="updateByExampleWithBLOBs")
    int updateByExampleWithBLOBs(@Param("record") PmsBrand record, @Param("example") PmsBrandExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsBrandSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") PmsBrand record, @Param("example") PmsBrandExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsBrandSqlProvider.class, method="updateByPrimaryKeySelective")
