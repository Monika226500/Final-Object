...
import com.zhumeng.api.model.OmsOrderItem;
import com.zhumeng.api.model.OmsOrderItemExample;
...
public interface OmsOrderItemMapper {
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderItemSqlProvider.class, method="countByExample")
    long countByExample(OmsOrderItemExample example);

    @DeleteProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderItemSqlProvider.class, method="deleteByExample")
    ...
    @InsertProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderItemSqlProvider.class, method="insertSelective")
    int insertSelective(OmsOrderItem record);

    @SelectProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderItemSqlProvider.class, method="selectByExample")
    @Results({
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderItemSqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") OmsOrderItem record, @Param("example") OmsOrderItemExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderItemSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") OmsOrderItem record, @Param("example") OmsOrderItemExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderItemSqlProvider.class, method="updateByPrimaryKeySelective")
