...
import com.zhumeng.api.model.OmsOrderOperateHistory;
import com.zhumeng.api.model.OmsOrderOperateHistoryExample;
...
public interface OmsOrderOperateHistoryMapper {
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderOperateHistorySqlProvider.class, method="countByExample")
    long countByExample(OmsOrderOperateHistoryExample example);

    @DeleteProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderOperateHistorySqlProvider.class, method="deleteByExample")
    ...
    @InsertProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderOperateHistorySqlProvider.class, method="insertSelective")
    int insertSelective(OmsOrderOperateHistory record);

    @SelectProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderOperateHistorySqlProvider.class, method="selectByExample")
    @Results({
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderOperateHistorySqlProvider.class, method="updateByExampleSelective")
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderOperateHistorySqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") OmsOrderOperateHistory record, @Param("example") OmsOrderOperateHistoryExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.OmsOrderOperateHistorySqlProvider.class, method="updateByPrimaryKeySelective")
