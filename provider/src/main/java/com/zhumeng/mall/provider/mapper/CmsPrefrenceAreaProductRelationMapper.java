...
import com.zhumeng.api.model.CmsPrefrenceAreaProductRelation;
import com.zhumeng.api.model.CmsPrefrenceAreaProductRelationExample;
...
public interface CmsPrefrenceAreaProductRelationMapper {
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.CmsPrefrenceAreaProductRelationSqlProvider.class, method="countByExample")
    long countByExample(CmsPrefrenceAreaProductRelationExample example);

    @DeleteProvider(type= com.zhumeng.mall.provider.mapper.CmsPrefrenceAreaProductRelationSqlProvider.class, method="deleteByExample")
    ...
    @InsertProvider(type= com.zhumeng.mall.provider.mapper.CmsPrefrenceAreaProductRelationSqlProvider.class, method="insertSelective")
    int insertSelective(CmsPrefrenceAreaProductRelation record);

    @SelectProvider(type= com.zhumeng.mall.provider.mapper.CmsPrefrenceAreaProductRelationSqlProvider.class, method="selectByExample")
    @Results({
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.CmsPrefrenceAreaProductRelationSqlProvider.class, method="updateByExampleSelective")
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.CmsPrefrenceAreaProductRelationSqlProvider.class, method="updateByExample")
    ...
    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.CmsPrefrenceAreaProductRelationSqlProvider.class, method="updateByPrimaryKeySelective")
