...
import com.zhumeng.api.model.PmsProductExample;
...
public interface PmsProductMapper {
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsProductSqlProvider.class, method="countByExample")
    long countByExample(PmsProductExample example);

    @DeleteProvider(type= com.zhumeng.mall.provider.mapper.PmsProductSqlProvider.class, method="deleteByExample")
    ...
    @InsertProvider(type= com.zhumeng.mall.provider.mapper.PmsProductSqlProvider.class, method="insertSelective")
    @Options(useGeneratedKeys=true, keyProperty="id", keyColumn="id")//返回主键送到输入形参中
    int insertSelective(PmsProduct record);

    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsProductSqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
    ...
    @SelectProvider(type= com.zhumeng.mall.provider.mapper.PmsProductSqlProvider.class, method="selectByExample")
    @Results({
        @Result(column="id", property="id", jdbcType= JdbcType.BIGINT, id=true),
        @Result(column="brand_id", property="brandId", jdbcType= JdbcType.BIGINT),
        @Result(column="product_category_id", property="productCategoryId", jdbcType= JdbcType.BIGINT),
    ...
    @Results({
        ...
        @Result(column="product_category_id", property="cateParentId",
                one = @One(select="com.zhumeng.mall.provider.mapper.PmsProductCategoryMapper.selectParentIdById")
        ),
        @Result(property = "productLadderList",javaType = List.class,column="id",//阶梯价格
                many = @Many(select="com.zhumeng.mall.provider.mapper.PmsProductLadderMapper.selectLadderByProductId")
        ),
        @Result(property = "productFullReductionList",javaType = List.class,column="id",//满减价格
                many = @Many(select="com.zhumeng.mall.provider.mapper.PmsProductFullReductionMapper.selectFullByProductId")
        ),
        @Result(property = "memberPriceList",javaType = List.class,column="id",//会员价格
                many = @Many(select="com.zhumeng.mall.provider.mapper.PmsMemberPriceMapper.selectMemberByParentId")
        ),
        @Result(property = "skuStockList",javaType = List.class,column="id",//SKU库存表
                many = @Many(select="com.zhumeng.mall.provider.mapper.PmsSkuStockMapper.selectProductSkuByParentId")
        ),
        @Result(property = "productAttributeValueList",javaType = List.class,column="id",//存储信息表
                many = @Many(select="com.zhumeng.mall.provider.mapper.PmsProductAttributeValueMapper.selectAttributeByParentId")
        ),

        @Result(property = "subjectProductRelationList",javaType = List.class,column="id",//存储信息表
                many = @Many(select="com.zhumeng.mall.provider.mapper.CmsSubjectProductRelationMapper.selectSubjectProductById")
        ) ,
        @Result(property = "prefrenceAreaProductRelationList",javaType = List.class,column="id",//存储信息表
                many = @Many(select="com.zhumeng.mall.provider.mapper.CmsPrefrenceAreaProductRelationMapper.selectPrefrenceProductById")
        )

    })
    PmsProduct getUpdateInfo(Long id);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductSqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") PmsProduct record, @Param("example") PmsProductExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductSqlProvider.class, method="updateByExampleWithBLOBs")
    int updateByExampleWithBLOBs(@Param("record") PmsProduct record, @Param("example") PmsProductExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") PmsProduct record, @Param("example") PmsProductExample example);

    @UpdateProvider(type= com.zhumeng.mall.provider.mapper.PmsProductSqlProvider.class, method="updateByPrimaryKeySelective")
