...
import com.zhumeng.api.dto.OmsOrderDeliveryParam;
import com.zhumeng.api.dto.OmsOrderQueryParam;
import com.zhumeng.api.model.OmsOrder;
import com.zhumeng.api.model.OmsOrderExample;
...
public interface OmsOrderMapper {
    ...
    @Results({
        ...
        @Result(property = "orderItemList",javaType = List.class,column="id",
                many = @Many(select="com.zhumeng.mall.provider.mapper.OmsOrderItemMapper.selectItemByOrderid")),
        @Result(property = "historyList",javaType = List.class,column="id",
                many = @Many(select="com.zhumeng.mall.provider.mapper.OmsOrderOperateHistoryMapper.selectHistoryByOrderId"))
